...
const DEXS = {
  ...
  Biswap: {
    type: 'V2',
    router: ethers.utils.getAddress('0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8'),
    factory: ethers.getAddress('0x858E3312ed3A876947EA49d572A7C42DE08af7EE')
  },
  ApeSwap: {
    type: 'V2',
    router: ethers.utils.getAddress('0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7'),
    factory: ethers.getAddress('0x0841BD0B734E4F5853f0dD8d7Ea041c241fb0Da6')
  },
  BakerySwap: {
    type: 'V2',
    router: ethers.utils.getAddress('0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F'),
    factory: ethers.getAddress('0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7')
  },
  MDEX: {
    type: 'V2',
    router: ethers.utils.getAddress('0x7DAe51BD3E3376B8c7c4900E9107f12Be3AF1bA8'),
  ...
  OneInch: {
    ...
    router: ethers.utils.getAddress('0x1111111254EEB25477B68fb85Ed929f73A960582'),
    factory: null,
    requiresApiKey: true
  },
  PancakeSwapV3: {
    type: 'V3',
    router: ethers.utils.getAddress('0x1b81D678ffb9C0263b24A97847620C99d213eB14'), // This is the V3 Router
